            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('regions.update', $region->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white dark:bg-stone-600 sm:p-6">
                            <label for="tppws" class="block font-medium text-sm text-gray-700 dark:text-gray-200">Assistance Regional Officer</label>
                            <select name="tppw_id" id="tppw" class="form-control select2 rounded-md shadow-sm mt-1 block w-full">
