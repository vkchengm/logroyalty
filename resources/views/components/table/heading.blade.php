...
>
    ...
    @else
        ...
        <button {{ $attributes->except('class') }} class='group flex items-center space-x-1 text-left text-xs leading-4 font-medium'>
            ...
            <span>
                ...
                @else
                    ...
                    <svg class="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill='none' stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><path d="M3 3h3v2h-3ZM3 6h6v2h-6ZM3 9h9v2h-9ZM3 12h12v2h-12Z" style="fill: hsl(180, 100%, 50%)" /></svg>
