        ...
        <div class="shadow overflow-hidden sm:rounded-md">
            ...
            <div class="py-2 px-6">
                <div class="grid grid-flow-col auto-cols-max overflow-x-auto ">
                    <div class="form-group px-1 py-1">
                        <label for="weigh_species" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">Species</label>
                        <select wire:model="weigh_species" name="weigh_species" id="weigh_species" class="form-control block rounded-md shadow-sm mt-1 dark:text-gray-900">
                    ...
                    <div class="form-group px-1 py-1">
                        <label for="weight" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">Weight</label>
                        <input type="number" wire:model="weight" name="weight" id="weight" class="form-control block rounded-md shadow-sm mt-1 w-28 dark:text-gray-900"  placeholder="Weight MT" wire:keydown.enter="calculateVolume()" wire:change="calculateVolume()" step="0.01">    
                    </div>

                    <div class="form-group px-1 py-1">
                        <label for="ratio" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">Ratio</label>
                        <input type="number" wire:model="ratio" name="ratio" id="ratio" class="form-control block rounded-md shadow-sm mt-1 w-24 dark:text-gray-900"  placeholder="Ratio" step="0.01">    
                    </div>
                
                    <div class="form-group px-1 py-1">
                        <label for="volume" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">Volume</label>
                        <input type="number" wire:model="volume" name="volume" id="volume" class="form-control rounded-md shadow-sm mt-1 w-24 dark:text-gray-900"  placeholder="Volume" readonly step="0.01">    
                    </div>
                
                    <div class="form-group px-1 py-1">
                        <label for="length" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">Length</label>
                        <input type="number" wire:model="length" name="length" id="length" class="form-control rounded-md shadow-sm mt-1 w-24 dark:text-gray-900"  placeholder="Length M" step="0.2">    
                    </div>
                
                    <div class="form-group px-1 py-1">
                        <label for="no_logs" class="form-control block dark:text-gray-300 font-medium text-sm text-gray-700">No. of logs</label>
                        <input type="number" wire:model="no_logs" name="no_logs" id="no_logs" class="form-control rounded-md shadow-sm mt-1 w-24 dark:text-gray-900"  placeholder="No. of logs" wire:keydown.enter="addWeighingDetails">    
                    </div>
                
                    <div class="form-group px-1 pt-7">
                        <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-40" wire:click.prevent="addWeighingDetails" wire:keydown.enter="addWeighingDetails">
                            Weighing Logs
                        </button>
                    </div>
                </div>
                <x-jet-input-error for="weigh_error"></x-jet-input-error>
            </div>
                ...
                <div >
                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <tr class="break-words">
                            ...
                            <th class="px-2 py-2">
                                <a href="#" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" wire:click.prevent="removeDetails()" wire:keydown.enter="removeDetails">Clear</a>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
