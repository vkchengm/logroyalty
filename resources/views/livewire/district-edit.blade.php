    ...
    <form method="post" action="{{ route('districts.update', $district->id) }}">
        ...
        <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white dark:bg-stone-600 sm:p-6">
                ...
                <input type="text" name="name" id="name" wire:model="name" class="form-input rounded-md shadow-sm mt-1 block w-full"
            ...
            <div class="px-4 py-5 bg-white dark:bg-stone-600 sm:p-6">
                ...
                <select name="region_id" id="region_id" class="form-control select2 rounded-md shadow-sm mt-1 block w-full">
            ...
            <div class="px-4 py-5 bg-white dark:bg-stone-600 sm:p-6">
                ...
                <select name="dfo_id" id="dfo_id" class="form-control select2 rounded-md shadow-sm mt-1 block w-full">
                    <option value="">Please select</option>
                    @foreach($dfos as $id => $user)
