                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 " id="products_table">
                                ...
                                <tr class="break-words text-left">
                                    ...
                                    <th class="font-light" rowspan="2">Year</th>
                                    <th class="font-light" rowspan="2">Month</th>
                                ...
                                @foreach ($permits as $index => $permit)
                                    <tr class="break-words">
                                        ...
                                        <td class='text-right'>{{ number_format($permit->total_vol_more_than_59) }}</td>
                                        ...
                                        <td class='text-right'>{{ number_format($permit->total_vol_between_44_to_59) }}</td>
