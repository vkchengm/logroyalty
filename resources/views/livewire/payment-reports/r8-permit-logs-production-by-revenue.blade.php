                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 " id="products_table">
                                ...
                                <tr class="break-words text-left">
                                    ...
                                    <th class="font-light text-right">Total Revenue</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr class="break-words border-t border-gray-300">
                                    ...
                                    <td class='text-right'>
                                        {{ number_format($this->totalVolume) }}
                                    </td>

                                    <td class='text-right'>
                                        {{ number_format($this->totalRoyalty) }}
                                    </td>

                                    <td class='text-right'>
                                        {{ number_format($this->totalPPM) }}
                                    </td>

                                    <td class='text-right'>
                                        {{ number_format($this->totalPremium) }}
                                    </td>

                                    <td class='text-right'>
                                        {{ number_format($this->totalFCF) }}
                                    </td>
