        ...
        <div class="shadow overflow-hidden sm:rounded-md">
            ...
            <div class="px-6 bg-white pt-4 pb-4">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 ">
                    ...
                    <div class="px-1">
                        <label for="Regions" class="block font-medium text-sm text-gray-700">Region</label>
            ...
            <div class="px-6 bg-white pt-2 pb-2">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 ">
                    ...
                    <div class="px-1">
                        <label for="year" class="block font-medium text-sm text-gray-700">Total Volume</label>
                        <div class="px-2">{{ $totalVol }}</div>
                    </div>    

                    <div class="px-1">
                        <label for="Regions" class="block font-medium text-sm text-gray-700">Total Amount</label>
