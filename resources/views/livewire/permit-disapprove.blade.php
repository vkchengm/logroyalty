<x-modal formAction="update">
    <x-slot name="title">
        ...
        Disapproval for TDP{{ str_pad($permit->id, 6, '0', STR_PAD_LEFT) }}
    ...
    <x-slot name="buttons">
        <div  class="py-4">
            ...
            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Disapprove</button>
        </div>
    </x-slot>
