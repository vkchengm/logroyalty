            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('users.update', $user->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="licensee" class="block font-medium text-sm text-gray-700">Licensee</label>
                            <input type="text" name="licensee" id="licensee" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('licensee', $user->licensee->name) }}" />
                            @error('licensee')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
