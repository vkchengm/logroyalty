...
class PermitReject extends ModalComponent
{
    // public $kppms = [];
    ...
    public function update()
    {
        ...
        $log = PermitLog::create([
            ...
            'system_info' => 'Inspection rejected',
        ]);

        $recipient = $this->permit->user;
        $tdpNo = 'TDP'.str_pad($this->permit->id, 6, '0', STR_PAD_LEFT);
        $subject = 'Permit No. '.$tdpNo.' inspection has been rejected';
    ...
    {
        return view('livewire.permit-reject');
    }
