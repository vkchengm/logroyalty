...
class ReportR2PermitLicensee0 extends Component
{
    public $districtId;
    public $districtIds;
    public $regionId;
    ...
    public function changeOption()
    {
        if ($this->yearSelected != '')
        {
            if ($this->regionId != '')
            {
                ...
                elseif ($this->districtId == '' && $this->licenseeId != '')
                {
                    $this->permits = Permit::whereYear('scaled_date', $this->yearSelected)->whereIn('district_id', $this->districtIds)->where('user_id',$this->licenseeId)->get();
            ...
            else
            {
                ...
                elseif ($this->districtId == '' && $this->licenseeId != '')
                {
                    $this->permits = Permit::whereYear('scaled_date', $this->yearSelected)->where('user_id',$this->licenseeId)->get();
        ...
        else
        {
            if ($this->regionId != '')
            {
                ...
                elseif ($this->districtId == '' && $this->licenseeId != '')
                {
                    $this->permits = Permit::whereIn('district_id', $this->districtIds)->where('user_id',$this->licenseeId)->get();
                }
                elseif ($this->districtId != '' && $this->licenseeId != '')
                {
            ...
            else
            {
                ...
                {
                    // dd($this->licenseeId);
                    $this->permits = Permit::where('user_id',$this->licenseeId)->get();
