...
class UpdateAccountCoupeRequest extends FormRequest
{
    /**
    ...
    public function persist(LicenseAccCoupe $licenseAccCoupe)
    {
        $licenseAccCoupe->update($this->validated());

        return $licenseAccCoupe->fresh();
    }
}
